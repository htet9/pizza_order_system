        ...
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <a href="{{ route('user#home') }}" class="text-dark">
                    <i class="fa-solid fa-arrow-left mx-1 mb-3"></i>back
                </a>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        <small class="pt-1">{{ $pizza->view_count + 1 }} <i class="fa-solid fa-eye mx-1"></i></small>
                    </div>
                    <h4 class="font-weight-semi-bold mb-4">{{ $pizza->price }} MMK</h4>
                    ...
                    @foreach ($pizzaList as $pizza)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('storage/'. $pizza->image) }}" style="height: 250px">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>{{ $pizza->price }}</h5><span class="mx-1">MMK</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
